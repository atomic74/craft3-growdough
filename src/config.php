...
/**
 * GrowDough config.php
 *
 * This file exists only as a template for the GrowDough settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'grow-dough.php'
